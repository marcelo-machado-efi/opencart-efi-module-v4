...
class Efi extends \Opencart\System\Engine\Controller
{
	...
	public function install(): void
	{
		...
		// Rotas que queremos liberar acesso e modificação
		$routes = [
			'extension/efi/payment/upload',
			'extension/efi/payment/save',
		];
	...
	/**
	 * Renderiza a tela de configuração do módulo no admin
	 */
	public function index(): void
	{
		...
		$data['save']                 = $this->url->link('extension/efi/payment/save',   'user_token=' . $this->session->data['user_token']);
		$data['upload']               = $this->url->link('extension/efi/payment/upload', 'user_token=' . $this->session->data['user_token']);
